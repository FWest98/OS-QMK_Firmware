...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_tkl_f13_ansi(
        _______,  KC_BRID,  KC_BRIU,  KC_TASK,  KC_FLXP,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,    RGB_TOG,  _______,  EE_CLR,   QK_BOOT,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,
        _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  _______,              _______,
        _______,            _______,  _______,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,              _______,            _______,
    ...
    [GREEK] = LAYOUT_tkl_f13_ansi(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,
        _______,  XP(PSI, PPSI),  X(ETA),  X(EPSILON),  X(RHO),  X(TAU),  XP(THETA, TTHETA),  X(UPSILON),  X(IOTA),  XP(OMEGA, OOMEGA),  XP(PI, PPI),  _______,  _______,    _______,  _______,  _______,  _______,
        _______,  X(ALPHA), XP(SIGMA, SSIGMA),  XP(DELTA, DDELTA),  XP(PHI, PPHI),  XP(GAMMA, GGAMMA),  X(PHIALT),  _______,  X(KAPPA),  XP(LAMBDA, LLAMBDA),  _______,  _______,              _______,
        KC_LSFT,            X(ZETA),  XP(XI, XXI),  X(XHI),  _______,  X(BETA),  X(NU),  X(MU),  _______,  _______,  _______,              KC_RSFT,            _______,
